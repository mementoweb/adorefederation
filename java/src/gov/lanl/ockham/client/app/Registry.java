...
public class Registry {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (File file : files) {
               ...
               if (f != null && reg.doPost(f))
                 logger.info("Registration Successful: " + file.getAbsolutePath());
               else
                 logger.info("Registration Failed: " + file.getAbsolutePath());     
            }
	 ...
	 */
	public IESRCollection getCollection(String identifier)
			throws MalformedURLException, IOException, SerializationException {
	 ...
	 * @throws IESRSerializationException
	 */
	public String get(String identifier) throws MalformedURLException,
     ...
     * @throws IESRSerializationException
     */
	public IESRService getService(String identifier)
			throws MalformedURLException, IOException, SerializationException {
		String str = doGet(identifier);
	 ...
	 * @throws IESRSerializationException
	 */
	public boolean put(IESRCollection coll) throws MalformedURLException,
			IOException, SerializationException {
     ...
     * @throws IESRSerializationException
     */
	public boolean put(IESRService service) throws MalformedURLException,
			IOException, SerializationException {
		ByteArrayOutputStream out = new ByteArrayOutputStream();
		service.write(out);
		out.close();
     ...
     * @throws MalformedURLException
     */
	public boolean delete(String identifier) throws MalformedURLException,
			IOException, SerializationException {
	 ...
	 * @throws MalformedURLException
	 */
	private String doGet(String identifier) throws IOException,
			MalformedURLException {
		URL url = new URL(baseurl.toString() + "/" + identifier);
		logger.debug("get " + url.toString());
		HttpURLConnection huc = (HttpURLConnection) (url.openConnection());
		BufferedReader reader = new BufferedReader(new InputStreamReader(huc
				.getInputStream()));
     ...
     * @throws MalformedURLException
     */
	private boolean doDelete(String identifier) throws IOException,
			MalformedURLException {
		URL url = new URL(baseurl.toString() + "/" + identifier);
		HttpURLConnection huc = (HttpURLConnection) (url.openConnection());
