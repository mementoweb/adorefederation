...
public class RegistryRecordHandler extends HttpServlet {
	...
	// Read database configuration file location from web.xml
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			String type = XMLUtil.getType(new ByteArrayInputStream(result
					.getBytes()));
			if ("Collection".equals(type)) {
				...
				throw new ServletException("not a recoganized format");
