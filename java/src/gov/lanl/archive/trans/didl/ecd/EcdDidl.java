...
package gov.lanl.archive.trans.didl.ecd;
...
public class EcdDidl implements DidlTransformer, ResourceParserInterface {
    private AI didWriter;
    private Logger log = Logger.getLogger(EcdDidl.class.getName());
    private static javax.xml.parsers.DocumentBuilderFactory dbf = null;
    private static byte[] xmlDec = new byte[0];
    private static final String COLLECTION = "info:sid/library.lanl.gov:ecd";
        ...
        if (rindex.toString().equals("1")) {
            ...
            try {
                ...
                if (!skip) {
                    ...
                    if (arcmimetype.indexOf("ecd+") > 0) {
                        arcmimetype = arcmimetype.replaceAll("ecd\\+", "");
                        type = ECDXML;
                    }
                    ...
                    if (type == MARCXML) {
                        ...
                        didWriter.addComponent(
                                ...
                                arcid,
                                digest,
                                AdoreConstants.ECD_XML_FORMATID,
                                created,
                                creator,
                                arcmimetype,
                                null,
