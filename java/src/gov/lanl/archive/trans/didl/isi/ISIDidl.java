...
import gov.lanl.didlwriter.profile.isi.AIREF;
...
public class ISIDidl implements DidlTransformer, ResourceParserInterface {
    private AIREF didWriter;
    private Logger log = Logger.getLogger(ISIDidl.class.getName());
    ...
    private static final String COLLECTION = "info:sid/library.lanl.gov:isi";
                ...
                if (!skip) {
                    ...
                    if (type == SEM1) {
                        ...
                        didWriter.addComponent(
                                ...
                                arcid,
                                digest,
                                AdoreConstants.ISI_RAW_FORMATID,
                                created,
                                creator,
                                arcmimetype,
                                null,
