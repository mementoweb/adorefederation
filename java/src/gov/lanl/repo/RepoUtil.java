        ...
        try {
            ...
            if (operation.equals("update")) {
                if (repourl.equals(null)) {
                    throw new Exception(
                            "-repourl [url of repository] requered for update");
                }
                ...
                if (xupdate.equals(null)) {
                    throw new Exception(
                            "-xupdate [file with xupdate statment ] requered");
                }
                ...
                if (repourl.equals(null)) {
                    throw new Exception(
                            "-repourl [url of repository] requered for delete");
                }
                if (identifier.equals(null)) {
                ...
                if (repourl.equals(null)) {
                    throw new Exception(
                            "-repourl [url of repository] required for put");
                }
                if (xmlfile.equals(null)) {
                    throw new Exception(
                            "-xmlfile [file with pmp xml  ] required");
                }
                ...
                // I think I will delete this operation

                if (propfile.equals(null)) {
                    throw new Exception(
                            "-propfile [specific property file of repository] requered for update");
                }
                if (repourl.equals(null)) {
                    throw new Exception(
                            "-repourl [url of repository] requered for update");
                ...
                if (prefix.equals(null)) {
                    throw new Exception(
                            "-metadataprefix [metadataprefix of repository] requered for update");
                }
                if (xupdate.equals(null)) {
                    throw new Exception(
                            "-xupdate [file with xupdate statment ] requered");
