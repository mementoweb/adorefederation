...
public class ARCFileId extends OAIPMHId {

    static Logger log = Logger.getLogger(ARCFileId.class.getName());
    ...
    public String getId(String meta) throws Exception {
        ...
        try {
            ...
            if (rootNS == RepoProperties.ARC_REG_NS)
                ipath = "//tb:ARCfileId";
            else
                throw new Exception("**** Expected " + RepoProperties.ARC_REG_NS + ", but " + rootNS + " is referenced");
