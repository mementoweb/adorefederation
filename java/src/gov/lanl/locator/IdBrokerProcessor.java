 ...
 */
public class IdBrokerProcessor extends AbstractContextObjectProcessor {
     ...
     * @throws Throwable
     */
    public IdBrokerProcessor(AbstractContextObjectFormat contextObjectFormat)
            throws Throwable {
        ContextObject[] contextObjects = contextObjectFormat.getContextObjects();
        IdBrokerService service = new IdBrokerService(contextObjects[0]);
