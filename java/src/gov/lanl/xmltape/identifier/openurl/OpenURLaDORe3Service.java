...
public class OpenURLaDORe3Service extends IdentifierResolverService {
    ...
    protected void getIdentifiersList(String referent) {
        try {
            bytes = idResolver.listIdentifiers(referent);
