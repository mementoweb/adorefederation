...
public class OpenURLaDORe2Service extends IdentifierResolverService {
    
    static Logger log = Logger.getLogger(OpenURLaDORe2Service.class.getName());
    
    public OpenURLaDORe2Service(ContextObject contextObject) throws OpenURLException, IOException {
        super(contextObject);
        ...
        getLocations(referent, resolver);
    }

    private void getLocations(String referent, String resolver) {
        try {
            bytes = idResolver.getRecordsList(referent, resolver);
