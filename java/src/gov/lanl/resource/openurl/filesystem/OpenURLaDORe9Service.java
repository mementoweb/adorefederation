...
/**
 * The OpenURLaDORe9 OpenURL Service
 * 
 * @author Ryan Chute
 */
public class OpenURLaDORe9Service implements Service {

    private ResourceReader reader;
    private static final String svc = "info:lanl-repo/svc/ore";
    private String resolver;
    
    /**
     * Construct an openurl-aDORe9 web service class.
     * 
     * @param openURLConfig
     * @param classConfig
     * @throws ResolverException 
     */
    public OpenURLaDORe9Service(OpenURLConfig openURLConfig, ClassConfig classConfig) throws ResolverException {
            String propFile;
            try {
    ...
    public OpenURLResponse resolve(ServiceType serviceType, 
        ...
        responseFormat = "application/rdf+xml";
