...
public class OpenURLaDORe9OREBuilder {
	...
	private String getResourceMapDescription() {
		...
		String desc = "\n<rdf:Description rdf:about=\"" + rem + "\">" +
		"  <rdf:type rdf:resource=\"http://www.openarchives.org/ore/terms/ResourceMap\"/>" +
		"  <ore:describes rdf:resource=\"" + baseUrl + "/aggregation\" />" +
	...
	private String getAggregationHeader() {
		String desc = "\n<rdf:Description rdf:about=\"" + baseUrl + "/aggregation\">" +
			"  <rdf:type rdf:resource=\"http://www.openarchives.org/ore/terms/Aggregation\"/>" +
			"  <ore:isDescribedBy rdf:resource=\"" + baseUrl + "/rem/rdf\" />" + 
			"  <dcterms:created rdf:datatype=\"http://www.w3.org/2001/XMLSchema#dateTime\">" +
			creationDate +
			"</dcterms:created>";
		return desc;
