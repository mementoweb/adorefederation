...
public class BDBWriterTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        append = "/Users/rchute/Documents/djatoka/imagetest/00001.jp2";
        sourceUri = "http://test/";
        rw = new ResourceWriter(props);
    }
    
    public static Date parseDate(String utc) throws ParseException {
    ...
    public void testWrite() throws Exception {
        ...
        for (CDXRecord i : reader.getCdxInstance().getCDXRecords()) {
        	...
        	id = "info:lanl-repo/ds/" + i.getChecksum();
            rw.write(id, mimeType, bis, parseDate(utcDate), recordLength, checksum, repoId, sourceUri);
            if (u == 100) {
                t = u + t;
