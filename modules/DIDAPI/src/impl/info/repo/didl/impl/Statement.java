...
/**
 * Provides a Statement type instance of an <code>Asset</code>.
 * 
...
public class Statement extends Asset {
     ...
     */
	public Statement() {
        super(Asset.Type.STATEMENT);
    }
    
    /**
     * Creates a new Statement instance with associated identifier
     * @param id identifier of instance
     */
    public Statement(final String id) {
        super(Asset.Type.STATEMENT, id);
    }
}
