...
public class MyComplexComponent {
     ...
     */            
    public MyComplexComponent(COMPONENT_TYPE type, String id, String mimetype,
            URI resource_uri, String content) {
     ...
     */
    public MyComplexComponent(COMPONENT_TYPE type, String id, String mimetype,
            URI resource_uri, String content, String copyright, String usage) {
        this.setType(type);
        this.setId(id);
    ...
    public ComponentType create(DIDLType didl) throws Exception {
        ...
        if (usage != null)
            mc.setUsage(usage);
        com.addDescriptor(didl.newDescriptor()).addStatement(
                MyComplexDidlHelper.newXMLStatement(didl, mc));
     ...
     * @throws Exception
     */
    public static MyComplexComponent parse(COMPONENT_TYPE type,
            ComponentType com) throws Exception {
        ...
        for (DescriptorType desc : com.getDescriptors()) {
            ...
            if (DII.class.isInstance(content)) {
                ...
                mc.setId(ct.getId());
                if (ct.getResourceUri() != null)
                  mc.setResourceUri(new URI(ct.getResourceUri()));
