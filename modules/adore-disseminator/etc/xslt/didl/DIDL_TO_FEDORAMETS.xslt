...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xlink="http://www.w3.org/TR/xlink" xmlns:mets="http://www.loc.gov/METS/" xmlns:didl="urn:mpeg:mpeg21:2002:02-DIDL-NS" xmlns:diext="http://library.lanl.gov/2004-04/STB-RL/DIEXT" xmlns:dii="urn:mpeg:mpeg21:2002:01-DII-NS" exclude-result-prefixes="xlink xsi xsl didl diext">
  ...
  -->
		<xsl:element name="mets:mets">
			...
			<xsl:if test="/didl:DIDL/@diext:DIDcreated">
   ...
   -->
	<xsl:template name="METSHDR">
		<xsl:element name="mets:metsHdr">
			<xsl:attribute name="CREATEDATE"><xsl:value-of select="/didl:DIDL/@diext:DIDcreated"/></xsl:attribute>
		</xsl:element>
	</xsl:template>
	<!--
   ###############################################################
