...
package gov.lanl.adore.demo.didl.content;
...
/**
 * <code>DII</code> defines the object container and serializers for all DII
...
public class DII implements DIDLSerializerType, DIDLDeserializerType {
    ...
    public static final String DII_SCHEMA_LOCATION = "http://standards.iso.org/ittf/PubliclyAvailableStandards/MPEG-21_schema_files/dii/dii.xsd";
     ...
     */
    public void write(OutputStream stream, Object object)
        ...
        out.print(" " + XSI_PREFIX + ":schemaLocation=\"" + DII_NAMESPACE + " "
                + DII_SCHEMA_LOCATION + "\"");
        out.print(">");
    ...
    private void addSchemaLocation(Node node) {
        ...
        el.setAttributeNS(XSI_NAMESPACE, SCHEMA_LOCATION_ATT, DII_NAMESPACE
                + " " + DII_SCHEMA_LOCATION);
    }

    /**
     * Reads a DII XML Fragment from specified InputStream and returns a
     * populated DII instance.
     */
