...
public class MultiTapeResolver extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            defaultProperties.put("processorClassName","gov.lanl.xmltape.identifier.openurl.IdentifierProcessor");
