...
public class DCIdentifierProcessor extends DerefProcessor {
    ...
    static Logger log = Logger.getLogger(DCIdentifierProcessor.class.getName());
    ...
    public ProcessInfo processContent(String record, ARCFileWriter arcwriter) {
        ...
        try {
            ...
            if (e >= 2 && e <= 4)
                ...
                resourceFile = util.getLink(util.getPage(id,"OAI Resource Harvester"),  exts);
