...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:didl="urn:mpeg:mpeg21:2002:02-DIDL-NS" xmlns:diext="http://library.lanl.gov/2006-09/STB-RL/DIEXT" xmlns:diadm="http://library.lanl.gov/2005-08/aDORe/DIADM/" xmlns:dii="urn:mpeg:mpeg21:2002:01-DII-NS" xmlns:dc="http://purl.org/dc/elements/1.1/" exclude-result-prefixes="marc didl diext diadm dii dc">
	...
	<xsl:include href="../SOLR-shared/SOLR-abstracts.xsl"/>
	...
	<xsl:include href="../SOLR-shared/SOLR-keywords.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-keyword-Biosis.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-keyword-Inspec.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-keyword-ISI.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-language.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-LANLflag.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-list.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-names.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-numbers.xsl"/>
	<xsl:include href="../SOLR-shared/SOLR-roles.xsl"/>
	...
	<xsl:include href="../SOLR-shared/SOLR-655.xsl"/>
	
	
	<!--files used for mapping treatment codes and document types -->
	<xsl:variable name="treatDoc" select="document('../SOLR-shared/TreatmentCodes.xml')"/>
	<xsl:variable name="docType" select="document('../SOLR-shared/DocumentTypes.xml')"/>
