...
public class DidlSigProcessor extends DerefProcessor {
    ...
    public ProcessInfo processContent(String record, ARCFileWriter arcwriter) {
        ...
        try {
            ...
            // Map MetaLevel = this.verify_anonimos(metadata,
            // this.getAboutsStr(abouts));

            if (!util.verify_record(record)) {
                String msg = "Metadata Verification Problem:"
                        + util.getMessage();
            ...
            // I am checking that every component has signature
            // I am checking that ref atribute of resource is the same as ref in
            // signature
            ...
            for (int i = 0; i < cnodes.getLength(); i++) {
                ...
                // setting mimetype,ref and xpath
