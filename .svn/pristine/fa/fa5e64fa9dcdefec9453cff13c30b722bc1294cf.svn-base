...
public class ArchiveIO {
     ...
     */
    public SingleTapeWriter openSingleTapeWriter(String tapename)
            throws ArchiveException {
     ...
     * @throws ArchiveException
     */
    public SingleTapeWriter openSingleTapeWriter(String tapename, String storageDir)
            throws ArchiveException {
        try {
            if (storageDir == null)
                return tw.openTapeWriter(tapename);
            else
                return tw.openTapeWriter(tapename, storageDir);
        } catch (Exception ex) {
            throw new ArchiveException("error in openSingleTapeWriter "
                    + tapename, ex);
        }
    }
     ...
     * @throws ArchiveException
     */
    public SingleTapeReader openSingleTapeReader(String tapename)
            throws ArchiveException {
        try {
            SingleTapeReader reader = tw.openTapeReader(tapename);
            return reader;
        } catch (Exception ex) {
            throw new ArchiveException("error in openSingleTapeReader "
                    + tapename, ex);
        }
    }
     ...
     * @throws ArchiveException
     */
    public SingleTapeReader openSingleTapeReader(String tapename, String storageDir, String indexDir) 
            throws ArchiveException {
        try {
            if (storageDir == null || indexDir == null)
                return tw.openTapeReader(tapename);
            else
                return tw.openTapeReader(tapename, storageDir, indexDir);
        } catch (Exception ex) {
     ...
     * @throws ArchiveException
     */
    public ARCFileWriter openARCFileWriter(String arcname)
            throws ArchiveException {
     ...
     * @throws ArchiveException
     */
    public ARCFileWriter openARCFileWriter(String arcname, String storageDir)
            throws ArchiveException {
        try {
            ...
            ARCFileWriter arcwriter = new ARCFileWriter(arcfileDir,
                    arcfileName, compression);
            return arcwriter;
        } catch (Exception ex) {
            throw new ArchiveException("error in openArcFileWriter "
                    + arcname, ex);
        }
    }
}
