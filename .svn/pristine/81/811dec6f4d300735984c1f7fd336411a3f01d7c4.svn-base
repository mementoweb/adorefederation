...
public class SingleTapeResolver extends HttpServlet {
    private static final long serialVersionUID = 5694656811577992642L;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        try {
            ...
            defaultProperties.put("processorClassName","gov.lanl.objectdb.openurl.IdentifierProcessor");
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {
            // get query args
            Map rawMap = req.getParameterMap();
