...
public class GetSpecifiedStream extends AbstractService {
	public GetSpecifiedStream(OpenURLConfig openURLConfig,
	...
	/*
	 * public GetSpecifiedStream(OpenURLConfig openURLConfig, ClassConfig
	 * classConfig) throws TransformerException {
	 * 
	 * super(openURLConfig, classConfig); }
	 * 
	 */
