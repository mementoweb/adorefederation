...
public class LinkWrapperService extends DefaultXSLTService {
    private String baseuri = null;
    private String openurl = null;
	 
    public LinkWrapperService(OpenURLConfig openURLConfig, ClassConfig classConfig) throws TransformerException {
	...
	sp.setBaseURI(res_url);
        String output = sp.toLinkSeekerPage(co);
      
        Resource result = new Resource();
       
	
	result.setBytes(output.getBytes("UTF-8"));
        result.setContentType("redirectURL");
       System.out.println("linkseeker" +output);
        return result;
    }
