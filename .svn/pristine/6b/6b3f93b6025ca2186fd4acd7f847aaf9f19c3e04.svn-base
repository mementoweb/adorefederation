...
package gov.lanl.didlwriter.profile.pubmed;
...
public class PubMedArticle {
	public static final String BIBLIOGRAPHIC_SEMANTICID = "info:citethisway/sem/1";
	public static final String METADATA_DIGEST_SEMANTICID = "info:citethisway/sem/2";
	public static final String PUBMED_ARTICLE_FORMATID = "info:citethisway/fmt/2";
	public static final String PUBMED_CREATOR_ID = "info:citethisway/creator/PubMed";
	public static final String DIADM_PROFILEID = "info:citethisway/pro/1";
    public enum COMPONENT_TYPE {PUBMEDARTICLEXML};
    ...
    private AdoreComponent pubMedArticleCom;
    ...
    public AdoreComponent getPubMedArticleCom() {
        return pubMedArticleCom;
    }
     ...
     * 
     * @param type 
     *            The PubMedArticle.COMPONENT_TYPE
     * @param componentID
     ...
     */
    public void addComponent(PubMedArticle.COMPONENT_TYPE type, String componentID,
        ...
        if (digest != null) {
            ...
            diiRelatedId.setRelationshipType(METADATA_DIGEST_SEMANTICID);
        }
        ...
        if ((type == PubMedArticle.COMPONENT_TYPE.PUBMEDARTICLEXML) && (content != null)) {
        ...
        if (type == COMPONENT_TYPE.PUBMEDARTICLEXML) {
            if (creator != null && creator.length() > 0)
                diadm.setCreator(creator);
            diadm.getSemantic().add(BIBLIOGRAPHIC_SEMANTICID);
            pubMedArticleCom = com;
        } 
    }
    ...
    public AdoreDIDL create() throws LANLDIDLException {
        try {
            ...
            diadm.setFormat(DIADM_PROFILEID);
            if (collection != null)
            ...
            // add Component
            rootItem.getComs().add(pubMedArticleCom);

            didl.setItem(rootItem);
            return didl;
        } catch (Exception ex) {
            throw new LANLDIDLException("error in create PubMed Article DIDL record", ex);
        }
    ...
    public void parse(java.io.InputStream stream) throws LANLDIDLException {
        try {
            ...
            pubMedArticleCom = didl.getItem().getComs().get(0);
        } catch (Exception ex) {
