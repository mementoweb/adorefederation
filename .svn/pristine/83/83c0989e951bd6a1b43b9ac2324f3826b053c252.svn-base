...
public class ProxyTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        oaiservice
                .setLocator("http://barracuda.lanl.gov:8080/project/moai2/ECD_DUBLIN-2006-09-04_2ec3f14a-41bd-11db-8d79-b0a8c271beda");
        ...
        services.put(oaipmhid, new RegistryRecord(oaipmhid, datestamp,
                oaiservice));
        services.put(openurlid, new RegistryRecord(openurlid, datestamp,
                openurlservice));

    }

    public void testLRMatch() throws Exception {
        Proxy proxy = new Proxy(Proxy.Operation.LISTRECORDS, collections,
                services, datestamp, datestamp, null);
        assertNotNull(proxy.getResult());
    }

    public void testLRNoMatch() throws Exception {
        Proxy proxy = new Proxy(Proxy.Operation.LISTRECORDS, collections,
                services, "2005-01-01", "2005-01-01", null);
    ...
    public void testLRSet() throws Exception {
        ...
        Proxy proxy = new Proxy(Proxy.Operation.LISTRECORDS, collections,
                services, datestamp, datestamp, sets.getSetSpec());
    ...
    public void testLIMatch() throws Exception {
        Proxy proxy = new Proxy(Proxy.Operation.LISTIDENTIFIERS, collections,
                services, datestamp, datestamp, null);
        Object obj = proxy.getResult();
        assertNotNull(obj);
