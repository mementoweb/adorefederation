...
public class Get {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 1) {
            System.err
                    .println("usage: java gov.lanl.ockham.put.client.Get <identifier> ");
            System.exit(1);
        }

        Get get = new Get(new URL(PropertiesUtil.getGlobalProperty(ServiceRegistryConstants.PUT_BASEURL)));
        System.out.println(get.get(args[0]));
    }
