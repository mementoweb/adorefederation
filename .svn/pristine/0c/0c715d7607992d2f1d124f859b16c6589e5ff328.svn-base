...
<input type="hidden" name="stylesheet" value="google2"/>
  ...
  <xsl:template match="doc">
   <div class="doc">
      <table width="100%">
        ...
        <xsl:element name="A">
        <xsl:attribute name="href">#</xsl:attribute>
        <xsl:attribute name="onClick">javascript:goURL('http://adore08.lanl.gov:8080/adore-disseminator/service?url_ver=Z39.88-2004&amp;rft_val_fmt=http%3A//purl.lanl.gov/aDORe/schemas/2007-01/version.xhtml&amp;svc_val_fmt=http%3A//purl.lanl.gov/aDORe/schemas/2007-01/chunklist.xhtml&amp;svc_id=info%3Alanl-repo/svc/toc.atom&amp;rft_id=<xsl:value-of select="$recID"/>')</xsl:attribute>
        <xsl:value-of select="$recID"/></xsl:element> 
        </font>
        </span>
        <br/><br/>
             </td>
