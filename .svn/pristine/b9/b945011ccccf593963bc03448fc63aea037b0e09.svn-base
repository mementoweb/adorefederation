...
public class PutPostClient {
    public String execPut(String strurl, String xmlstr) throws Exception {
        String data = "verb=PutRecord&xml="
    ...
    public String execUpdate(String strurl, String id, String xmlstr)
            throws Exception {
        String data = "verb=UpdateRecord&identifier="
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length != 2) {
            System.out
                    .println("usage: PutFromFile [properties file] [file with pmpxml]");
